...
export default class Monatslistensammlung {
    ...
    _eintrag_hinzufuegen(eintrag) {
        let eintragsmonat = parseInt(eintrag.datum().toLocaleString("de-DE", {month: "numeric"}));
        let eintragsjahr = parseInt(eintrag.datum().toLocaleString("de-DE", {year: "numeric"}));
    ...
    /**
     * Diese private Methode entfernt die bereits bestehende Monatslistensammlung, wenn vorhanden.
     */
    _entfernen() {
