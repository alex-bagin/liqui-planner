/**
 * Das Modul "Eintrag" stellt die Klasse "Eintrag" zur Verügung.
...
export default class Eintrag {
    ...
    /**
     * Der Konstuktor generiert bei Instanziirung der Klasse "Eintrag"
     * anhand der u.g. Parameter ein Eintrags-Objekt mit den u.g. Eigenschaften.
     * @param {String} titel - der Titel des Eintrags
     * @param {Number} betrag - der Btrag des Eintrags (in Cent, ganzzahlig) 
     ...
     * @property {Number} _betrag - der Btrag des Eintrags (in Cent, ganzzahlig) 
     * @property {String} _typ - der Typ des Eintrags (entweder "einnahme" oder "ausgabe") 
   ...
   /**
    ...
    /**
     * Getter-Methode für den Timesatamp des Eintrags.
     * @returns {Number} - der Timestamp des Eintrags
     */
    timestamp() {
     ...
     * @returns {Element} - das HTML des Eintrags
     */
    html() {
        return this._html;
    }
    ...
    /**
     * Diese private Methode generiert das HTML eins Eintrags und setzt das Click-Event für den
