...
export default class Gesamtbilanz {
        ...
        eintraege.forEach(eintrag => {
            switch (eintrag.typ()) {
                ...
                case "ausgabe":
                    ...
                    break;
                default:
                    this.fehler.push(`Der Typ "${typ()}" ist nicht bekannt!`);
                    break;
            };
        });
        this._html = this._html_generieren();
    ...
    _html_generieren() {
        ...
        ausgaben_zeile.setAttribute("class", "gesamtbilanz-zeile augaben");        
    ...
    /**
     * Diese private Methode entfernt eine bereits bestehende Gesamtbilanz, wenn vorahnden.
     */
    _entfernen() {
